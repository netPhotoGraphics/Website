...
class phpbb_cache_container extends \Symfony\Component\DependencyInjection\Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = [
            ...
            'cleantalk.antispam.cleantalk' => 'getCleantalk_Antispam_CleantalkService',
            'cleantalk.antispam.cleantalk_request' => 'getCleantalk_Antispam_CleantalkRequestService',
            'cleantalk.antispam.cleantalk_sfw' => 'getCleantalk_Antispam_CleantalkSfwService',
            'cleantalk.antispam.cron.task.cleantalk_antispam_check_payment_status' => 'getCleantalk_Antispam_Cron_Task_CleantalkAntispamCheckPaymentStatusService',
            'cleantalk.antispam.cron.task.cleantalk_antispam_sfw_logs_send' => 'getCleantalk_Antispam_Cron_Task_CleantalkAntispamSfwLogsSendService',
            'cleantalk.antispam.cron.task.cleantalk_antispam_sfw_update' => 'getCleantalk_Antispam_Cron_Task_CleantalkAntispamSfwUpdateService',
            'cleantalk.antispam.listener' => 'getCleantalk_Antispam_ListenerService',
            'cleantalk.antispam.main_model' => 'getCleantalk_Antispam_MainModelService',
            ...
            'hifikabin.obscurecontactus.listener' => 'getHifikabin_Obscurecontactus_ListenerService',
            ...
            'rmcgirr83.authorizedforurls.listener' => 'getRmcgirr83_Authorizedforurls_ListenerService',
        ...
        $this->privates = [
            ...
            'cleantalk.antispam.cleantalk' => true,
            'cleantalk.antispam.cleantalk_request' => true,
            'cleantalk.antispam.cleantalk_sfw' => true,
            'cleantalk.antispam.cron.task.cleantalk_antispam_check_payment_status' => true,
            'cleantalk.antispam.cron.task.cleantalk_antispam_sfw_logs_send' => true,
            'cleantalk.antispam.cron.task.cleantalk_antispam_sfw_update' => true,
            'cleantalk.antispam.listener' => true,
            'cleantalk.antispam.main_model' => true,
            'config' => true,
            'config.php' => true,
            'config_text' => true,
            ...
            'hifikabin.obscurecontactus.listener' => true,
            'hook_finder' => true,
            'http_kernel' => true,
            ...
            'request' => true,
            'request_stack' => true,
            'rmcgirr83.authorizedforurls.listener' => true,
            'router' => true,
    ...
    /**
     * Gets the private 'cleantalk.antispam.cleantalk' shared service.
     *
     * @return \cleantalk\antispam\model\Cleantalk
     */
    protected function getCleantalk_Antispam_CleantalkService()
    {
        return $this->services['cleantalk.antispam.cleantalk'] = new \cleantalk\antispam\model\Cleantalk(${($_ = isset($this->services['request']) ? $this->services['request'] : ($this->services['request'] = new \phpbb\request\request(NULL, true))) && false ?: '_'});
    }

    /**
     * Gets the private 'cleantalk.antispam.cleantalk_request' shared service.
     *
     * @return \cleantalk\antispam\model\CleantalkRequest
     */
    protected function getCleantalk_Antispam_CleantalkRequestService()
    {
        return $this->services['cleantalk.antispam.cleantalk_request'] = new \cleantalk\antispam\model\CleantalkRequest();
    }

    /**
     * Gets the private 'cleantalk.antispam.cleantalk_sfw' shared service.
     *
     * @return \cleantalk\antispam\model\CleantalkSFW
     */
    protected function getCleantalk_Antispam_CleantalkSfwService()
    {
        return $this->services['cleantalk.antispam.cleantalk_sfw'] = new \cleantalk\antispam\model\CleantalkSFW(${($_ = isset($this->services['template']) ? $this->services['template'] : $this->getTemplateService()) && false ?: '_'}, ${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'}, ${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'}, ${($_ = isset($this->services['request']) ? $this->services['request'] : ($this->services['request'] = new \phpbb\request\request(NULL, true))) && false ?: '_'}, ${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'phpbb_');
    }

    /**
     * Gets the private 'cleantalk.antispam.cron.task.cleantalk_antispam_check_payment_status' shared service.
     *
     * @return \cleantalk\antispam\cron\task\cleantalk_antispam_check_payment_status
     */
    protected function getCleantalk_Antispam_Cron_Task_CleantalkAntispamCheckPaymentStatusService()
    {
        $this->services['cleantalk.antispam.cron.task.cleantalk_antispam_check_payment_status'] = $instance = new \cleantalk\antispam\cron\task\cleantalk_antispam_check_payment_status(${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'});

        $instance->set_name('cron.task.cleantalk_antispam_check_payment_status');

        return $instance;
    }

    /**
     * Gets the private 'cleantalk.antispam.cron.task.cleantalk_antispam_sfw_logs_send' shared service.
     *
     * @return \cleantalk\antispam\cron\task\cleantalk_antispam_sfw_logs_send
     */
    protected function getCleantalk_Antispam_Cron_Task_CleantalkAntispamSfwLogsSendService()
    {
        $this->services['cleantalk.antispam.cron.task.cleantalk_antispam_sfw_logs_send'] = $instance = new \cleantalk\antispam\cron\task\cleantalk_antispam_sfw_logs_send(${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'}, ${($_ = isset($this->services['cleantalk.antispam.cleantalk_sfw']) ? $this->services['cleantalk.antispam.cleantalk_sfw'] : $this->getCleantalk_Antispam_CleantalkSfwService()) && false ?: '_'});

        $instance->set_name('cron.task.cleantalk_antispam_sfw_logs_send');

        return $instance;
    }

    /**
     * Gets the private 'cleantalk.antispam.cron.task.cleantalk_antispam_sfw_update' shared service.
     *
     * @return \cleantalk\antispam\cron\task\cleantalk_antispam_sfw_update
     */
    protected function getCleantalk_Antispam_Cron_Task_CleantalkAntispamSfwUpdateService()
    {
        $this->services['cleantalk.antispam.cron.task.cleantalk_antispam_sfw_update'] = $instance = new \cleantalk\antispam\cron\task\cleantalk_antispam_sfw_update(${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'}, ${($_ = isset($this->services['cleantalk.antispam.cleantalk_sfw']) ? $this->services['cleantalk.antispam.cleantalk_sfw'] : $this->getCleantalk_Antispam_CleantalkSfwService()) && false ?: '_'});

        $instance->set_name('cron.task.cleantalk_antispam_sfw_update');

        return $instance;
    }

    /**
     * Gets the private 'cleantalk.antispam.listener' shared service.
     *
     * @return \cleantalk\antispam\event\main_listener
     */
    protected function getCleantalk_Antispam_ListenerService()
    {
        return $this->services['cleantalk.antispam.listener'] = new \cleantalk\antispam\event\main_listener(${($_ = isset($this->services['template']) ? $this->services['template'] : $this->getTemplateService()) && false ?: '_'}, ${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'}, ${($_ = isset($this->services['config_text']) ? $this->services['config_text'] : $this->getConfigTextService()) && false ?: '_'}, ${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'}, ${($_ = isset($this->services['request']) ? $this->services['request'] : ($this->services['request'] = new \phpbb\request\request(NULL, true))) && false ?: '_'}, ${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, ${($_ = isset($this->services['cleantalk.antispam.cleantalk_sfw']) ? $this->services['cleantalk.antispam.cleantalk_sfw'] : $this->getCleantalk_Antispam_CleantalkSfwService()) && false ?: '_'}, ${($_ = isset($this->services['cleantalk.antispam.main_model']) ? $this->services['cleantalk.antispam.main_model'] : $this->getCleantalk_Antispam_MainModelService()) && false ?: '_'}, ${($_ = isset($this->services['symfony_request']) ? $this->services['symfony_request'] : $this->getSymfonyRequestService()) && false ?: '_'}, 'php');
    }

    /**
     * Gets the private 'cleantalk.antispam.main_model' shared service.
     *
     * @return \cleantalk\antispam\model\main_model
     */
    protected function getCleantalk_Antispam_MainModelService()
    {
        return $this->services['cleantalk.antispam.main_model'] = new \cleantalk\antispam\model\main_model(${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'}, ${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'}, ${($_ = isset($this->services['request']) ? $this->services['request'] : ($this->services['request'] = new \phpbb\request\request(NULL, true))) && false ?: '_'}, ${($_ = isset($this->services['log']) ? $this->services['log'] : $this->getLogService()) && false ?: '_'}, ${($_ = isset($this->services['cleantalk.antispam.cleantalk']) ? $this->services['cleantalk.antispam.cleantalk'] : $this->getCleantalk_Antispam_CleantalkService()) && false ?: '_'}, ${($_ = isset($this->services['cleantalk.antispam.cleantalk_request']) ? $this->services['cleantalk.antispam.cleantalk_request'] : ($this->services['cleantalk.antispam.cleantalk_request'] = new \cleantalk\antispam\model\CleantalkRequest())) && false ?: '_'}, ${($_ = isset($this->services['config_text']) ? $this->services['config_text'] : $this->getConfigTextService()) && false ?: '_'}, './../', 'php');
    }
    ...
    protected function getCron_TaskCollectionService()
    {
        ...
        $instance->add('cleantalk.antispam.cron.task.cleantalk_antispam_sfw_logs_send');
        $instance->add('cleantalk.antispam.cron.task.cleantalk_antispam_sfw_update');
        $instance->add('cleantalk.antispam.cron.task.cleantalk_antispam_check_payment_status');
    ...
    protected function getDispatcherService()
    {
        ...
        $instance->addListener('core.user_setup', [0 => function () {
            return ${($_ = isset($this->services['cleantalk.antispam.listener']) ? $this->services['cleantalk.antispam.listener'] : $this->getCleantalk_Antispam_ListenerService()) && false ?: '_'};
        ...
        $instance->addListener('core.page_footer_after', [0 => function () {
            return ${($_ = isset($this->services['cleantalk.antispam.listener']) ? $this->services['cleantalk.antispam.listener'] : $this->getCleantalk_Antispam_ListenerService()) && false ?: '_'};
        }, 1 => 'add_js_to_footer'], 0);
        $instance->addListener('core.posting_modify_submission_errors', [0 => function () {
            return ${($_ = isset($this->services['cleantalk.antispam.listener']) ? $this->services['cleantalk.antispam.listener'] : $this->getCleantalk_Antispam_ListenerService()) && false ?: '_'};
        }, 1 => 'check_comment'], 0);
        $instance->addListener('core.posting_modify_submit_post_before', [0 => function () {
            return ${($_ = isset($this->services['cleantalk.antispam.listener']) ? $this->services['cleantalk.antispam.listener'] : $this->getCleantalk_Antispam_ListenerService()) && false ?: '_'};
        }, 1 => 'change_comment_approve'], 0);
        $instance->addListener('core.user_add_modify_data', [0 => function () {
            return ${($_ = isset($this->services['cleantalk.antispam.listener']) ? $this->services['cleantalk.antispam.listener'] : $this->getCleantalk_Antispam_ListenerService()) && false ?: '_'};
        }, 1 => 'check_newuser'], 0);
        ...
        $instance->addListener('core.user_setup', [0 => function () {
            return ${($_ = isset($this->services['hifikabin.obscurecontactus.listener']) ? $this->services['hifikabin.obscurecontactus.listener'] : $this->getHifikabin_Obscurecontactus_ListenerService()) && false ?: '_'};
        }, 1 => 'load_language_on_setup'], 0);
        ...
        $instance->addListener('core.permissions', [0 => function () {
            return ${($_ = isset($this->services['rmcgirr83.authorizedforurls.listener']) ? $this->services['rmcgirr83.authorizedforurls.listener'] : $this->getRmcgirr83_Authorizedforurls_ListenerService()) && false ?: '_'};
        }, 1 => 'add_permission'], 0);
        $instance->addListener('core.posting_modify_message_text', [0 => function () {
            return ${($_ = isset($this->services['rmcgirr83.authorizedforurls.listener']) ? $this->services['rmcgirr83.authorizedforurls.listener'] : $this->getRmcgirr83_Authorizedforurls_ListenerService()) && false ?: '_'};
        }, 1 => 'posting_modify_message_text'], 0);
        $instance->addListener('core.posting_modify_submit_post_before', [0 => function () {
            return ${($_ = isset($this->services['rmcgirr83.authorizedforurls.listener']) ? $this->services['rmcgirr83.authorizedforurls.listener'] : $this->getRmcgirr83_Authorizedforurls_ListenerService()) && false ?: '_'};
        }, 1 => 'posting_modify_submit_post_before'], 0);
        $instance->addListener('core.ucp_profile_modify_signature', [0 => function () {
            return ${($_ = isset($this->services['rmcgirr83.authorizedforurls.listener']) ? $this->services['rmcgirr83.authorizedforurls.listener'] : $this->getRmcgirr83_Authorizedforurls_ListenerService()) && false ?: '_'};
        }, 1 => 'modify_signature'], 0);
        $instance->addListener('core.ucp_pm_compose_modify_parse_before', [0 => function () {
            return ${($_ = isset($this->services['rmcgirr83.authorizedforurls.listener']) ? $this->services['rmcgirr83.authorizedforurls.listener'] : $this->getRmcgirr83_Authorizedforurls_ListenerService()) && false ?: '_'};
        }, 1 => 'modify_message_text'], 0);
        $instance->addListener('core.posting_modify_submission_errors', [0 => function () {
            return ${($_ = isset($this->services['rmcgirr83.authorizedforurls.listener']) ? $this->services['rmcgirr83.authorizedforurls.listener'] : $this->getRmcgirr83_Authorizedforurls_ListenerService()) && false ?: '_'};
        }, 1 => 'modify_submission_errors'], 0);
    ...
    /**
     * Gets the private 'hifikabin.obscurecontactus.listener' shared service.
     *
     * @return \hifikabin\obscurecontactus\event\listener
     */
    protected function getHifikabin_Obscurecontactus_ListenerService()
    {
        return $this->services['hifikabin.obscurecontactus.listener'] = new \hifikabin\obscurecontactus\event\listener(${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'}, ${($_ = isset($this->services['template']) ? $this->services['template'] : $this->getTemplateService()) && false ?: '_'});
    }
    ...
    /**
     * Gets the private 'rmcgirr83.authorizedforurls.listener' shared service.
     *
     * @return \rmcgirr83\authorizedforurls\event\listener
     */
    protected function getRmcgirr83_Authorizedforurls_ListenerService()
    {
        return $this->services['rmcgirr83.authorizedforurls.listener'] = new \rmcgirr83\authorizedforurls\event\listener(${($_ = isset($this->services['auth']) ? $this->services['auth'] : ($this->services['auth'] = new \phpbb\auth\auth())) && false ?: '_'}, ${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'}, ${($_ = isset($this->services['config_text']) ? $this->services['config_text'] : $this->getConfigTextService()) && false ?: '_'}, ${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'}, NULL);
    }
