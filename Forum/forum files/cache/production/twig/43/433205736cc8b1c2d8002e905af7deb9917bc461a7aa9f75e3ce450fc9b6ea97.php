...
/* search_results.html */
class __TwigTemplate_72f5d5725eadf59cfff423183bcd2b4d2199e7c0828a3143d03e024d735647a0 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["searchresults"]) {
                ...
                if ((twig_get_attribute($this->env, $this->source, $context["searchresults"], "S_ROW_COUNT", [], "any", false, false, false, 178) % 2 == 1)) {
                    echo "bg1";
                } else {
                    echo "bg2";
                }
